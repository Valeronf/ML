...
def forward_propagation(T, parameters):
    """
...
def model(X, Y, learning_rate = 0.01, num_iterations = 80000, print_cost = True, lambd = 0.7, keep_prob = 1):
    """
...
parameters = model(X, Y, lambd = 0.7, learning_rate = 0.01)
